...
with open('config.yml', 'r') as yml_config:
    global_config = yaml.load(yml_config)
...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, block, layers):
        ...
        anchor_ratios = global_config['MODEL']['ANCHOR']['RATIOS']
        anchor_scales = global_config['MODEL']['ANCHOR']['SCALES']
        self.anchors = Anchors(pyramid_levels=[3,4,5,6,7], ratios=anchor_ratios, scales=anchor_scales) 
